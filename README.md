...
> **Not yet re-validated on PAI v5.0.0.** This module is from the v4 era; v5 restructured its voice plumbing under Pulse. The core package above runs fine without it. Details in the [voice README](voice/).
