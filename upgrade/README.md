...
upgrade/
├── README.md              # This file
├── UPGRADE.md             # AI-driven upgrade phases (the main deliverable)
...
The upgrade is AI-driven: you tell your AI assistant to read UPGRADE.md and follow the phases. The AI handles detection, backup, migration, and verification. Each phase is independently verifiable and resumable.
